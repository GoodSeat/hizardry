...
spells = Map.fromList [
    (SpellID 11, Spell.Define {
        ...
        , Spell.infomation = "敵1体に1～8ダメージ(火炎)"
    })
    ,
    ...
    (SpellID 13, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "敵1グループの行動を止める(睡眠)\n眠った敵には直接攻撃のダメージが2倍"
    })
    ,
    ...
    (SpellID 31, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "敵1グループに4～24ダメージ(火炎)"
    })
    ,
    (SpellID 32, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "敵1グループに3～18ダメージ"
    })
    ,
    ...
    (SpellID 42, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "敵1グループに6～36ダメージ(冷気)"
    })
    ,
    (SpellID 43, Spell.Define {
        ...
        , Spell.effect     = Spell.Damage (parse' "6d6")
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "敵1グループに6～36ダメージ(火炎)"
    })
    ,
    ...
    (SpellID 52, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "レベル7以下の敵全てを即死させる。ただし不死系には無効"
    })
    ,
    (SpellID 53, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "敵1グループに8～64ダメージ(冷気)"
    })
    ,
    ...
    (SpellID 71, Spell.Define {
        ...
        , Spell.infomation = "座標指定テレポート。戦闘時はランダムテレポート"
    })
    ,
    ...
    (SpellID 73, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "敵全てに10～100ダメージ"
    })
    ...
    (SpellID 112, Spell.Define {
        ...
        , Spell.infomation = "味方一人のHPを1～8回復する"
    })
    ,
    ...
    (SpellID 114, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InCamp, Spell.InBattle]
        , Spell.infomation = "30歩の間3ブロック先まで迷宮を照らし、隠し扉も見える"
    })
    ,
    ...
    (SpellID 122, Spell.Define {
        ...
        , Spell.enableIn   = []
        , Spell.infomation = "宝箱に仕掛けられた罠の種類を95%で見抜く"
    })
    ,
    (SpellID 123, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "敵1グループの行動を止める(凝固)"
    })
    ,
    (SpellID 124, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "敵1グループの呪文を封じる"
    })
    ,
    (SpellID 131, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InCamp, Spell.InBattle]
        , Spell.infomation = "3ブロック先まで迷宮を照らし、隠し扉も見える"
    })
    ,
    ...
    (SpellID 133, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InCamp, Spell.InBattle]
        , Spell.infomation = "冒険中敵の正体を確定させる"
    })
    ,
    ...
    (SpellID 141, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InCamp, Spell.InBattle]
        , Spell.infomation = "味方一人のHPを2～16回復する"
    })
    ,
    ...
    (SpellID 144, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InCamp, Spell.InBattle]
        , Spell.infomation = "冒険中パーティ全員のACを2低下させる"
    })
    ,
    (SpellID 151, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InCamp, Spell.InBattle]
        , Spell.infomation = "味方一人のHPを3～24回復する"
    })
    ,
    ...
    (SpellID 153, Spell.Define {
        ...
        , Spell.effect     = Spell.Damage (parse' "3d8")
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "敵1グループに3～24ダメージ(火炎)"
    })
    ,
    (SpellID 154, Spell.Define {
        ...
        , Spell.effect     = Spell.Event (GameEventID 0) -- TODO:not implmented.
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "行方不明者の迷宮内の位置を大雑把に示す"
    })
    ,
    (SpellID 155, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InCamp]
        , Spell.infomation = "死んだ味方1人をHP1で蘇生させる"
    })
    ,
    (SpellID 156, Spell.Define {
        ...
        , Spell.effect     = Spell.AddStatusError [(Dead, read "min(70,(lv-o.lv)*10+30)", "")]
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "敵1体を即死させる。ただし不死系や特定の敵には無効"
    })
    ,
    (SpellID 161, Spell.Define {
        ...
        , Spell.effect     = Spell.Damage (parse' "6d6")
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "敵1グループに6～36ダメージ"
    })
    ,
    (SpellID 162, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InCamp, Spell.InBattle]
        , Spell.infomation = "味方1人のHPを全回復し、死・灰・ロスト以外を全て治療する"
    })
    ,
    (SpellID 163, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "敵1体のHPを1～8残して奪う"
    })
    ,
    (SpellID 164, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "全ての装備とほとんどの金を失って城に戻る"
    })
    ,
    (SpellID 171, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InBattle]
        , Spell.infomation = "敵全てに12～72ダメージ"
    })
    ,
    (SpellID 172, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InCamp]
        , Spell.infomation = "死または灰の味方1人をHPフルで蘇生させる"
    })
    ...
    (SpellID 201, Spell.Define {
        ...
        , Spell.enableIn   = [Spell.InCamp, Spell.InBattle]
        , Spell.infomation = "30歩の間3ブロック先まで迷宮を照らし、ダークゾーンをかき消す"
    })
    ]
